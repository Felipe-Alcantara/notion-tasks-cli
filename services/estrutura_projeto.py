"""Compatibilidade para `services.estrutura_projeto` consolidado no `notion_starter`."""
...
try:
    _modulo = importlib.import_module("notion_starter.services.estrutura_projeto")
except ModuleNotFoundError:
    starter_src = Path(__file__).resolve().parents[2] / "notion-starter" / "src"
